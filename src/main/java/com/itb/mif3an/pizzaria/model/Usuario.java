...
@Entity
@Table(name = "usuarios")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE) //strategy = InheritanceType.SINGLE_TABLE: tipo de herança; unica
...
public abstract class Usuario { //classe abstrata não recebe, herda das classes filhas: adm, funcionario, cliente
    ...
    @Column(nullable = false, length = 45, insertable = false, updatable = false) //permite ser funcionario e admin, por exemplo
